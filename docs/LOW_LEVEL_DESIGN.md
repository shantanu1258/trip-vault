...
| `npm test -- --maxWorkers=4 --minWorkers=1`                    | 2026-09-19, test maintenance                                                                                                                                             | Pass: 674 tests across 102 files after consolidating 124 redundant/brittle cases; see test maintenance policy below |
| `npm run build`                                                | 2026-09-19, test maintenance                                                                                                                                             | Pass, including TypeScript and PWA generation; existing chunk-size and mixed-import advisories remain               |
| Documentation Prettier check                                   | 2026-09-19                                                                                                                                                               | Pass for changed canonical documents, README, changelog, conventions and historical-note pointers                   |
...
Local responsive checks through `7cdd785` verified the dark-mode inverted trip hero, Indian-grouped total, Next up navigation, and centered current-task placement with the 3.5-second highlight at 375×812. Earlier refinement checks covered 320px/375px phones and larger layouts. These were read-only checks against existing records, not production-PWA delivery, RLS, multi-device, or airplane-mode certification.
...
| Timeline filters and focus                    | `src/features/timeline/TimelineFilters.tsx`, `src/features/timeline/model.ts`, `src/features/timeline/scroll.ts`                                                                                                                                                                      | Draft date/type/display filters, date/type aliases, usable-viewport centering and three-pulse feedback                                                                                                                   |
