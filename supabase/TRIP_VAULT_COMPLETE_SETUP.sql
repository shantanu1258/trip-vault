...
-- 2026-09-17  Folded ordered cab stops, linked stop activities, and
...
--              and summarize named event, booking and expense changes.
...
-- ============================================================================
-- 202609170002_cab_journey_stops.sql
-- ============================================================================
...
-- Migration 202609210002_planning_items.sql
...
-- Migration 202609210003_activity_moments.sql
...
-- Migration 202609220001_planning_archive_integrity.sql
...
notify pgrst, 'reload schema';
commit;
-- END SECTION: JOURNEY EARLY REMINDERS
