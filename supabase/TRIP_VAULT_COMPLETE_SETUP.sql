...
-- It contains every migration in the required order and includes the timezone
-- trigger repair. Individual files under supabase/migrations remain the source
