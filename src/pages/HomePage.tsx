...
import { AlertTriangle, ArrowRight, Clock3, CloudDownload, FileCheck2, MapPin, MapPinned, Plus, Sparkles, TicketCheck, UserPlus, UsersRound } from "lucide-react";
import { useEffect, useState } from "react";
import { Link } from "react-router-dom";
import { AppShell } from "../components/AppShell";
import { CostTotals, ErrorCard, LoadingCard, PageHeader, TripCard } from "../components/TripUi";
...
import { listBookings, listFlightLegsForTrip, listRequirements, listVaultDocuments } from "../features/workspace/api";
        ...
        {focusedTrip && (
          <>
            ...
            <section className="mt-5 grid gap-4 md:grid-cols-2">
              <div className="surface-card page-enter p-5"><CostTotals costs={costsQuery.data ?? []} /><Link to={`/trips/${focusedTrip.id}?add=cost`} className="mt-3 inline-flex items-center gap-2 text-sm font-extrabold text-brand"><Plus className="size-4" /> Add cost</Link></div>
