...
describe("fresh launch trip routing", () => {
  ...
  // Calendar/timezone boundaries belong to presentation.test.ts. Here verify
  // that the router opens the eligible trip at the launch-window boundary.
  it("opens the only relevant trip ten days before departure", async () => {
    listTrips.mockResolvedValue([trip("soon", 10, 15)]);
    renderLaunch();
