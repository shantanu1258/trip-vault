...
function ConfirmationExample() {
  ...
  return <>
    <button type="button" onClick={async () => setResult(await confirm({ title: "Archive event?", message: "The event can be restored later.", confirmLabel: "Archive", tone: "danger" }) ? "confirmed" : "cancelled")}>Archive event</button>
...
describe("ConfirmDialogProvider", () => {
  it("uses an in-app confirmation dialog instead of a browser prompt", async () => {
    ...
    render(<ConfirmDialogProvider><ConfirmationExample /></ConfirmDialogProvider>);
