...
export function Brand({ compact = false }: { compact?: boolean }) {
  return (
    ...
    >
      ...
      {!compact && (
        <span>
          <span className="block font-display text-lg font-extrabold leading-none tracking-[-0.03em]">
            Trip Vault
          </span>
          <span className="mt-1 block text-[0.62rem] font-bold uppercase tracking-[0.2em] text-muted">
            Ready when you are
          </span>
        </span>
      )}
